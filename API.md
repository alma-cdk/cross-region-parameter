...
| <code><a href="#@alma-cdk/cross-region-parameter.CrossRegionParameter.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@alma-cdk/cross-region-parameter.CrossRegionParameter.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@alma-cdk/cross-region-parameter.CrossRegionParameter.with.parameter.mixins"></a>
